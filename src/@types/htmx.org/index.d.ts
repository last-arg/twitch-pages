// Base on https://github.com/leevigraham/typescript-htmx-types/blob/main/src/%40types/htmx.org/index.d.ts
...
declare namespace htmx {
     ...
     * }
     */
    function logger(elt: HTMLElement, event: Event, data: any): void;
     ...
     */
    function trigger(elt: HTMLElement | string, name: string, details: any): any;
